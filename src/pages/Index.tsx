...
// 🔥 ADDED USERS (ONLY 1 CAN BE SELECTED)
const users = {
  Denise: "aKRJANFuRVKXTgQP63giaw",
  "Peter Stephan": "xcUauzdUQ8SPhqf7kwUH9w",
  Shabir: "kNeTbjC0T9u0M8I8geOFdQ",
};

const Index = () => {
  // 🔥 ADDED SELECTED USER STATE
  const [selectedUser, setSelectedUser] =
    useState<keyof typeof users>("Shabir");
  ...
  const selectedAccountId = users[selectedUser];
    ...
    <div className="flex h-screen w-full overflow-hidden">
      <div className="w-[40%] border-r border-border">
        <ChatSidebar
          ...
          selectedUser={selectedUser} // 🔥 SENT TO SIDEBAR
          onUserChange={setSelectedUser} // 🔥 CHANGE FROM SIDEBAR
          users={Object.keys(users)} // 🔥 DROPDOWN OPTIONS
        />
      </div>
